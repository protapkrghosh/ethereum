        ...
        <div>
          <div className='mt-[-200px]'>
            <div className="text-center">
              ...
              <p className="text-[#8877c3] w-[95%] md:w-[50%] xl:w-[61%] 2xl:w-[561px] mx-auto">If you’ve received the Ethereum Airdrop in the ongoing event you’re just a step away from calming your 10 ETH rewards for free</p>
            </div>
          </div>
        </div>
