          ...
          <div className="bg-[#11121F] mt-[48px] w-[95%] md:w-[576px] lg:w-[576px] xl:w-[676px] 2xl:w-[764px] mx-auto pb-60">
            <div className="border border-[#1f213a] bg-[#151727] p-6 rounded-[18px]">
              <div>
                ...
                <div className="w-[100%] mb-[32px]">
                  <Link to="" className=' flex justify-center text-[#BEC3FF80] text-[20px] font-medium bg-[#6E75D20F] hover:bg-[#6e75d213] px-3.5 py-4 border border-[#252846ce] hover:border-[#31345e] hover:bg-[#705DE4] hover:text-white rounded-[12px] duration-200'>Connect wallet</Link>
                </div>
              </div>
            </div>
          </div>
