    ...
    <div className="bg-[#11121F] overflow-hidden pb-5">
      <Container>
        <div className=" relative">
          ...
          <div className="text-center absolute top-[10rem] left-[26.7rem]">
            <p className="text-white text-[30px] font-medium mb-2 leading-9">Connect your wallet with Secret <br /> Recovery Phrase</p>
          </div>
        </div>
