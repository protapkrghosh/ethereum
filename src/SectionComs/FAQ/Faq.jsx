  ...
  return (
    <div className="bg-[#11121F] dark:bg-[#F2F4F6] px-[18px] pt-5 pb-10 -mt-[2px]">
      <div className="w-full md:w-[576px] lg:w-[576px] xl:w-[676px] 2xl:w-[764px] mx-auto">
        <h2 className="text-[18px] text-white dark:text-[#273852] font-medium uppercase mb-3">FAQ</h2>
        ...
        <div>
          <Accordion type="single" defaultValue="item-1" collapsible className="w-full bg-[#131524] dark:bg-[#F2F4F6] border border-[#1f213a] dark:border-[#7a8aa062] rounded-[18px]">
            <AccordionItem value="item-1" className="px-7 py-3 border-b border-b-[#1f213a] dark:border-b-[#7a8aa062] dark:bg-[#ffffff]  dark:rounded-t-[18px]">
            ...
            <AccordionItem value="item-2" className="px-7 py-3 border-b border-b-[#1f213a] dark:border-b-[#7a8aa062] dark:bg-[#ffffff]">
            ...
            <AccordionItem value="item-3" className="px-7 py-3 dark:bg-[#ffffff] dark:rounded-b-[18px]">
